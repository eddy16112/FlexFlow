                             ...
                             Context ctx, Runtime* runtime)
{
  ...
  embed_forward<<<GET_BLOCKS(accOutput.rect.volume()), CUDA_NUM_THREADS, 0, hipGetTaskStream()>>>(
                              ...
                              Context ctx, Runtime *runtime)
{
  ...
  embed_backward<<<GET_BLOCKS(accOutput.rect.volume()), CUDA_NUM_THREADS, 0, hipGetTaskStream()>>>(
