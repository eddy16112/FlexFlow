                            ...
                            Context ctx, Runtime *runtime)
{
  ...
  hipLaunchKernelGGL((ones_kernel), dim3(GET_BLOCKS(filter_elements)), dim3(CUDA_NUM_THREADS), 0, 0, 
  ...
  hipLaunchKernelGGL((scale_kernel), dim3(GET_BLOCKS(conv->output.pdim[2])), dim3(CUDA_NUM_THREADS), 0, 0, 
