                                  ...
                                  size_t num_elements)
{
  ...
  if (use_cudnn(m->op_type)) {
    ...
    elewise_unary_forward_kernel<<<GET_BLOCKS(num_elements), CUDA_NUM_THREADS, 0, hipGetTaskStream()>>>(
                                   ...
                                   size_t num_elements)
{
  ...
  if (use_cudnn(m->op_type)) {
    ...
    elewise_unary_backward_kernel<<<GET_BLOCKS(num_elements), CUDA_NUM_THREADS, 0, hipGetTaskStream()>>>(
